<a href="#page"
    ...
    class="fixed bottom-8 md:top-100 right-4 sm:right-10 w-10 h-10 bg-bg-light flex items-center justify-center shadow-md transition-all duration-500 ease-in-out z-50 transform">
