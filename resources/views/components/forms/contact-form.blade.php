<div class="md:min-w-2xl">
    ...
    <x-forms.form method="POST" action="{{ route('contact.store') }}" class="max-w-xl mx-auto mt-10 space-y-6">
    ...
    @if (session()->has('success'))
        <div x-data="{ open: true }" x-show="open" class="fixed inset-0 flex justify-center items-center">
            ...
            <div @click.outside="open = false"
                ...
                <!-- Close Button -->
                <x-button @click="open = false" class="w-32">
                    OK
                </x-button>
            </div>
        </div>
