<footer class="flex flex-col py-4 md:flex-row justify-between items-center space-y-4 md:space-y-0 text-sm text-text">
    ...
    <div class="flex items-center space-x-4">
        <a href="https://github.com/yourprofile" target="_blank" aria-label="GitHub" class="hover:text-primary transition">
            <i class="fab fa-github fa-lg"></i>
        </a>
        <a href="https://linkedin.com/in/yourprofile" target="_blank" aria-label="LinkedIn" class="hover:text-primary transition">
            <i class="fab fa-linkedin fa-lg"></i>
        </a>
        <a href="mailto:youremail@example.com" aria-label="Email" class="hover:text-primary transition">
