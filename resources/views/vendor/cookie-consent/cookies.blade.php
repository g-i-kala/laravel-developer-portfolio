...
<style data-cookie-consent>
    {!! file_get_contents(LCC_ROOT . '/dist/style.css') !!} #cookies-policy .cookies__alert {
        border-radius: 0px;
        background-color: oklch(97% 0.005 260)
    }

    #cookies-policy .cookiesBtn__link {
        background-color: oklch(47% 0.18 264);
        border: 1px solid oklch(47% 0.18 264);
        border-radius: 0px;
