<x-layout>
    <x-sections.section id="hero">
        ...
        <div class="w-full sm:w-1/2 my-4">
          <p class="text-xl mt-4 text-secondary text-left" data-aos="fade-right" data-aos-delay="400">From syntax to style, </p>
            <p class="text-xl mt-4 text-secondary text-center" data-aos="fade" data-aos-delay="600">I build modern web experiences </p>
              <p class="text-xl mt-4 text-secondary text-right" data-aos="fade-left" data-aos-delay="800">with Laravel, PHP & WordPress.</p>
        </div>
